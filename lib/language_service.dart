...
class LanguageService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'photo_ai_prompt': {'ar': 'حلل صورة القدم هذه. ابدأ ردك بـ "خطر" إذا كانت هناك مشكلة أو "آمن" إذا كانت القدم سليمة. ثم وصف ما تراه في جملة أو جملتين، ثم أعطِ توصية قصيرة.', 'en': 'Analyze this foot photo. Start your reply with RISK if there is a problem or SAFE if the foot is healthy. Then describe what you see in 1-2 sentences, and give a short recommendation.', 'fr': 'Analysez cette photo de pied. Commencez par RISQUE s\'il y a un problème ou SÛR si le pied est sain. Décrivez ce que vous voyez en 1-2 phrases, puis donnez une courte recommandation.'},
