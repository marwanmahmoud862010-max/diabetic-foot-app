...
class LanguageService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'photo_analyze_ai': {'ar': 'تحليل باستخدام الذكاء الاصطناعي', 'en': 'Analyze with AI', 'fr': 'Analyser avec IA'},
    'photo_no_photo': {'ar': 'لا توجد صور لتحليلها، برجاء التقاط صورة أولاً', 'en': 'No photos to analyze, please capture a photo first', 'fr': "Aucune photo à analyser, veuillez d'abord prendre une photo"},
    'photo_analyzing_right': {'ar': 'جاري تحليل الرجل اليمنى...', 'en': 'Analyzing right foot...', 'fr': 'Analyse du pied droit...'},
    'photo_analyzing_left': {'ar': 'جاري تحليل الرجل اليسرى...', 'en': 'Analyzing left foot...', 'fr': 'Analyse du pied gauche...'},
    'photo_ai_prompt': {'ar': 'حلل صورة القدم هذه. أخبرني إذا كان هناك: احمرار، تورم، جروح، كالو، تغير في اللون، أو أي شيء غير طبيعي. ابدأ ردك بـ RISK لو في مشكلة أو SAFE لو القدم سليمة. رد بجملة واحدة قصيرة.', 'en': 'Analyze this foot photo. Tell me if there is: redness, swelling, wounds, callus, discoloration, or any abnormality. Start your reply with RISK if there is a problem or SAFE if the foot is healthy. Keep response to one short sentence.', 'fr': 'Analysez cette photo de pied. Dites-moi s\'il y a: rougeur, gonflement, plaies, callosités, décoloration ou anomalie. Commencez votre réponse par RISK s\'il y a un problème ou SAFE si le pied est sain. Répondez en une phrase courte.'},
