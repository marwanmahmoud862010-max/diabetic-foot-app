...
class LanguageService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'login_too_many_requests': {'ar': 'تم حظر تسجيل الدخول مؤقتًا بسبب كثرة المحاولات. حاول مرة أخرى لاحقًا.', 'en': 'Access temporarily blocked due to too many attempts. Try again later.', 'fr': 'Accès temporairement bloqué en raison de trop de tentatives. Réessayez plus tard.'},
    'login_weak_password': {'ar': 'كلمة المرور ضعيفة جدًا. اختر كلمة مرور أقوى.', 'en': 'Password is too weak. Choose a stronger password.', 'fr': 'Le mot de passe est trop faible. Choisissez un mot de passe plus fort.'},
    'login_error_generic': {'ar': 'فشل تسجيل الدخول. تحقق من بياناتك وحاول مرة أخرى.', 'en': 'Login failed. Check your credentials and try again.', 'fr': 'Échec de la connexion. Vérifiez vos identifiants et réessayez.'},
    ...
    'forgot_password_subtitle_done': {'ar': 'تم إرسال رابط إعادة تعيين كلمة المرور إلى بريدك. تحقق من صندوق الوارد والبريد المزعج.', 'en': "We've sent a password reset link to your email. Please check your inbox and Spam folder.", 'fr': "Nous avons envoyé un lien de réinitialisation à votre email. Vérifiez votre boîte de réception et les spams."},
    'forgot_send_code': {'ar': 'إرسال', 'en': 'Reset Password', 'fr': 'Réinitialiser'},
